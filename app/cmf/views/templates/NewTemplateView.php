...
function NewTemplateView() {
    ...
    ?>
        <form id="new-template-form" action="?page=newtemplate" method="post">
            <div>
                <h1>Создать новый шаблон</h1>
            </div>
            <div id="template-label">
                <div id="template-name">
                    <div class="horisontal-label-input large">
                        <label>Имя шаблона:</label>
                        <input type="text" name="nametemplate" placeholder="Имя шаблона" autocomplete="off" required>
                    </div>
